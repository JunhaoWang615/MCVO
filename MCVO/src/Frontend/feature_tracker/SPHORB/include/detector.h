...
typedef CvPoint xy;																			
typedef unsigned char sphbyte;																	

xy* sfast_corner_detect(const sphbyte* im, const sphbyte* mask, int xsize, int xstride, int ysize, int barrier, int* num);

int sfast_corner_score(const sphbyte* im, const int pixel[], int bstart);
